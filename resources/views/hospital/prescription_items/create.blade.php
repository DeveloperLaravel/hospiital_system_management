...
<div class="p-6 bg-gray-50 min-h-screen" dir="rtl">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">إضافة عنصر جديد للوصفة الطبية</h1>
                <p class="text-gray-600 mt-1">إضافة دواء جديد إلى وصفة طبية موجودة</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-l from-blue-600 to-blue-700 px-6 py-4">
            <h2 class="text-lg font-bold text-white flex items-center">
                ...
                إضافة عنصر للوصفة الطبية
            </h2>
        </div>

        <div class="p-6">
            <form method="POST" action="{{ route('prescription-items.store') }}" class="space-y-6">
                @csrf
